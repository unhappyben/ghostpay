// poseidon2 — vendored ESM port of poseidon-lite@0.3.0 (MIT, https://github.com/vimwitch/poseidon-lite),
// limited to the t=3 (two-input) permutation used for Privacy Pools precommitments.
// Constants + permutation are byte-identical to poseidon-lite/poseidon/index.js + constants/2.js.
// Verified in test-commitment.mjs against poseidon-lite itself and against a live pp-secret.json.
const PARAMS = {
...
// unstringifyBigInts, from poseidon-lite/poseidon/unstringify.js
...
const C2 = unstringifyBigInts(PARAMS);
export function poseidon2(inputs, nOuts) {
  return poseidon(inputs, C2, nOuts);
}
